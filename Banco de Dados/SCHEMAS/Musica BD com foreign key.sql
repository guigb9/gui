...
update Musica set FkAlbum=3 where idMusica in(4, 8);
update Musica set FkAlbum=4 where idMusica = 10;
update Musica set FkAlbum=5 where idMusica = 2;
update Musica set FkAlbum=6 where idMusica = 7;
update Musica set FkAlbum=7 where idMusica = 6;

select Musica.*, Album. nome as 'Álbum', gravadora from Musica, Album where FkAlbum = idAlbum;

select Musica.*, Album. nome as 'Álbum', gravadora from Musica, Album where FkAlbum = idAlbum and nome = 'Rock';

select Musica.*, Album. nome as 'Álbum', gravadora from Musica, Album where FkAlbum = idAlbum and gravadora = 'Rockeiro';
